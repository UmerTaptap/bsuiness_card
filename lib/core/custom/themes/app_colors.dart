...
class AppColors {
  ...
  static Color primaryDark = Colors.blue[300]!;


  static const cardColor1 = Colors.blueAccent;
  static const cardColor2 = Colors.lightBlueAccent;
  ...
  // AppBar Colors
  static const appBarLight = Colors.transparent;
  static const appBarDark = Colors.transparent;  // Same color for both

  // Error Colors
  static const errorLight = Color(0xFFB00020);
  static const errorDark = Color(0xFFCF6679);

  // Text Colors (on surfaces, backgrounds, etc.)
  ...
  // Chat Bubble Colors
  static const chatBubbleLight = Color(0xFFE44B2B);
  static const chatBubbleDark = Color(0xFFE44B2B);  // Same color for both
